...
class HashTable():
    ...
    def _find_free_slot(self, start):
        ...
        while True:
            ...
            index = (index + 1) % self.size  # wrap around to the beginning
...
# fill slots using the example formula
for c in "abcdefghijklmnopqrstuvwxyz":
    h.slots[(ord(c) * ord(c)) % h.size] = c

print(h._find_free_slot(0))   # expected: 1
print(h._find_free_slot(1))   # expected: 1
print(h._find_free_slot(10))  # expected: 10
